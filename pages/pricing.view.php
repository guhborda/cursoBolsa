  ...
  <div class="main-content bg-default" page="pricing">
          ...
          <div class="pricing card-group flex-column flex-md-row mb-3">
            <div class="card card-pricing border-0 text-center mb-4">
              <div class="card-header bg-transparent">
                  <div class="icon icon-xs icon-shape bg-primary shadow text-white" style="width:50px; height:50px">
                    <i class="fas fa-chart-line" style="font-size: 30px;"></i>
                    </div>
                <h4 class="text-uppercase ls-1 text-primary py-3 mb-0">Investidor</h4>
              </div>
              <div class="card-body px-lg-7">
                <div class="display-2">R$100</div>
                <span class="text-muted">-5% à vista</span>
            ...
            <div class="card card-pricing bg-gradient-success zoom-in shadow-lg rounded border-0 text-center mb-4" style="transform: scale(1.1);git ">
              <div class="card-header bg-transparent">
    ...
    font-size: 30px;"></i>
                ...
                <h4 class="text-uppercase ls-1 text-white py-3 mb-0">Aventureiro</h4>
              </div>
              <div class="card-body px-lg-7">
                <div class="display-1 text-white">$199</div>
                <span class="text-white">-5% à vista</span>
                <ul class="list-unstyled my-4">
                  <li>
                    <div class="d-flex align-items-center">
                      <div>
              ...
              <div class="card-footer bg-transparent" style="border-radius:0px 0px 5px 5px">
              <button type="button" class="btn btn-secondary ">Start free trial</button>
              </div>
            </div>
          </div>
        </div>
